...
//                mDatabase.child("cong").child("congvao").setValue(0);
        ...
        mDatabase.child("baixe").child("slot1").addValueEventListener(postListener);
        ...
        mDatabase.child("baixe").child("slot2").addValueEventListener(postListener2);
        ...
        mDatabase.child("baixe").child("slot3").addValueEventListener(postListener3);
        ...
        ValueEventListener postListener4 = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(value.equals("1"))
                {
                    ...
                    img4.setImageResource(R.drawable.a3);
            }
        ...
        mDatabase.child("baixe").child("slot4").addValueEventListener(postListener4);
